declare module 'node-pg-migrate' {
  export type MigrationBuilder = import('node-pg-migrate/dist/bundle/index.d.ts').MigrationBuilder;
  export type RunnerOption = import('node-pg-migrate/dist/bundle/index.d.ts').RunnerOption;
  export type RunMigration = import('node-pg-migrate/dist/bundle/index.d.ts').RunMigration;
  export const runner: (options: RunnerOption) => Promise<RunMigration[]>;
  export const MigrationBuilder: new () => MigrationBuilder;
  export const Migration: new (name: string, direction: 'up' | 'down', options?: any) => { up?: () => Promise<void>; down?: () => Promise<void> };
